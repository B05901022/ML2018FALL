...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec 19 11:09:32 2018
...
w2v_model = word2vec.Word2Vec.load("dcard_word2vec_only_words.model")
...
#cut the sentence
input_datas = [[j for j in i.split(',')[1]] for i in open('./test_x.csv', 'r').read().split('\n')[1:-1]]
...
model = Sequential()
model = load_model("hw4_model_only_words.h5")
prediction = model.predict_classes(test_data)

with open("result_only_words.csv", 'w') as f:
